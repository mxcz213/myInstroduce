...
export default class BaseInfo extends React.Component {
	...
	getYear(){
		...
		const myOlds = parseInt(year - myBornYear);
		const jobtimes = parseInt(year - firstJobTime);
		this.setState({
			myOlds:myOlds,
			jobtimes:jobtimes
		})
	...
	render(){
		return (
			<div className="base-info">
				...
				<div className="base-info-list">					
					<a className="inline-block mr20" href="https://github.com/mxcz213" target="_blank">
						<img width="30" height="30" src={github} className="icon-logo" />
					</a>
					<a className="inline-block" href="http://www.jianshu.com/u/b230cceb9ab1" target="_blank">
						<img width="30" height="30" src={jianshu} className="icon-logo" />
					</a>
				</div>
			</div>
		)
